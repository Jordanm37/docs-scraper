---
title: Poll - Clawdbot
url: https://docs.clawd.bot/automation/poll
---
...
clawdbot message poll --target [email protected] \
...
# MS Teams
clawdbot message poll --channel msteams --target conversation:19:[email protected] \
