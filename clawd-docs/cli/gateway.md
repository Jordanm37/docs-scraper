---
title: Gateway - Clawdbot
url: https://docs.clawd.bot/cli/gateway
---
...
* Unicast DNS-SD (Wide-Area Bonjour): `clawdbot.internal.` (requires split DNS + DNS server; see </gateway/bonjour>)
