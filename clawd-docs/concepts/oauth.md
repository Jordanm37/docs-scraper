---
title: Oauth - Clawdbot
url: https://docs.clawd.bot/concepts/oauth
---
...
## [​](#reusing-claude-code-/-codex-cli-oauth-tokens-recommended) Reusing Claude Code / Codex CLI OAuth tokens (recommended)
...
### [​](#bidirectional-sync-with-claude-code) Bidirectional sync with Claude Code
