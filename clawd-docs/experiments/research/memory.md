---
title: Memory - Clawdbot
url: https://docs.clawd.bot/experiments/research/memory
---
...
## [​](#north-star-model-hindsight-×-letta) North star model (Hindsight × Letta)
...
## [​](#proposed-architecture-markdown-source-of-truth-+-derived-index) Proposed architecture (Markdown source-of-truth + derived index)
...
## [​](#retain-/-recall-/-reflect-operational-loop) Retain / Recall / Reflect (operational loop)

### [​](#retain:-normalize-daily-logs-into-“facts”) Retain: normalize daily logs into “facts”
...
### [​](#reflect:-produce-stable-pages-+-update-beliefs) Reflect: produce stable pages + update beliefs
