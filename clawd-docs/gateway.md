...
url: https://docs.clawd.bot/gateway
---

# [​](#gateway-service-runbook) Gateway service runbook
...
## [​](#error-codes-res-error-shape) Error codes (res.error shape)
...
## [​](#keepalive-behavior) Keepalive behavior
...
## [​](#gateway-service-management-cli) Gateway service management (CLI)
