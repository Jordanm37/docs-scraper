---
title: Authentication - Clawdbot
url: https://docs.clawd.bot/gateway/authentication
---
...
## [​](#anthropic:-claude-code-cli-setup-token-supported) Anthropic: Claude Code CLI setup-token (supported)
