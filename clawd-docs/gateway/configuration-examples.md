---
title: Configuration examples - Clawdbot
url: https://docs.clawd.bot/gateway/configuration-examples
---
...
### [​](#anthropic-subscription-+-api-key,-minimax-fallback) Anthropic subscription + API key, MiniMax fallback
