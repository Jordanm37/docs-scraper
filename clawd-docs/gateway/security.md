...
### [​](#the-“find-the-truth”-attack) The “Find the Truth” Attack
...
### [​](#0-4-network-exposure-bind-+-port-+-firewall) 0.4) Network exposure (bind + port + firewall)
...
### [​](#0-6-1-browser-control-server-over-tailscale-recommended) 0.6.1) Browser control server over Tailscale (recommended)
...
### [​](#0-7-secrets-on-disk-what’s-sensitive) 0.7) Secrets on disk (what’s sensitive)
...
### [​](#0-8-logs-+-transcripts-redaction-+-retention) 0.8) Logs + transcripts (redaction + retention)
...
### [​](#5-secure-baseline-copy/paste) 5) Secure baseline (copy/paste)
...
### [​](#example:-read-only-tools-+-read-only-workspace) Example: read-only tools + read-only workspace
...
### [​](#example:-no-filesystem/shell-access-provider-messaging-allowed) Example: no filesystem/shell access (provider messaging allowed)
...
1. Email: [[email protected]](/cdn-cgi/l/email-protection#6615030513140f121f26050a07110248040912)
