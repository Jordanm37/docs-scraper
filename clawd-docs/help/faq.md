---
title: Faq - Clawdbot
url: https://docs.clawd.bot/help/faq
---
...
Usually no. Clawdbot needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see </gateway/local-models>. Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
### [​](#can-i-use-gpt-5-2-for-daily-tasks-and-codex-5-2-for-coding) Can I use GPT 5.2 for daily tasks and Codex 5.2 for coding
...
## [​](#chat-commands,-aborting-tasks,-and-“it-won’t-stop”) Chat commands, aborting tasks, and “it won’t stop”
