---
title: Installer - Clawdbot
url: https://docs.clawd.bot/install/installer
---
...
### [​](#why-git-is-needed) Why Git is needed
...
### [​](#why-npm-hits-eacces-on-fresh-linux) Why npm hits `EACCES` on fresh Linux
...
## [​](#install-cli-sh-non-root-cli-installer) install-cli.sh (non-root CLI installer)
