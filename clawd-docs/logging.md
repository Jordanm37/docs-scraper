---
title: Logging - Clawdbot
url: https://docs.clawd.bot/logging
---
...
### [​](#cli:-live-tail-recommended) CLI: live tail (recommended)
...
### [​](#control-ui-web) Control UI (web)

The Control UI’s **Logs** tab tails the same file using `logs.tail`.
See </web/control-ui> for how to open it.

### [​](#channel-only-logs) Channel-only logs
...
### [​](#file-logs-jsonl) File logs (JSONL)
...
## [​](#diagnostics-+-opentelemetry) Diagnostics + OpenTelemetry
...
### [​](#opentelemetry-vs-otlp) OpenTelemetry vs OTLP

* **OpenTelemetry (OTel)**: the data model + SDKs for traces, metrics, and logs.
* **OTLP**: the wire protocol used to export OTel data to a collector/backend.
* Clawdbot exports via **OTLP/HTTP (protobuf)** today.

### [​](#signals-exported) Signals exported
...
### [​](#diagnostic-event-catalog) Diagnostic event catalog
...
### [​](#enable-diagnostics-no-exporter) Enable diagnostics (no exporter)
...
### [​](#diagnostics-flags-targeted-logs) Diagnostics flags (targeted logs)
...
### [​](#export-to-opentelemetry) Export to OpenTelemetry
...
### [​](#exported-metrics-names-+-types) Exported metrics (names + types)
...
### [​](#exported-spans-names-+-key-attributes) Exported spans (names + key attributes)
...
### [​](#sampling-+-flushing) Sampling + flushing
...
### [​](#log-export-behavior) Log export behavior
