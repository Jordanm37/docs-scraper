---
title: Multi-Agent Sandbox & Tools - Clawdbot
url: https://docs.clawd.bot/multi-agent-sandbox-tools
---

# [​](#multi-agent-sandbox-&-tools-configuration) Multi-Agent Sandbox & Tools Configuration
