---
title: Exe dev - Clawdbot
url: https://docs.clawd.bot/platforms/exe-dev
---
...
## [​](#3-install-clawdbot) 3) Install Clawdbot
...
## [​](#5-remote-access-options) 5) Remote access options

### [​](#option-a-recommended-:-ssh-tunnel-loopback-only) Option A (recommended): SSH tunnel (loopback-only)
...
### [​](#option-b:-exe-dev-https-proxy-no-tunnel) Option B: exe.dev HTTPS proxy (no tunnel)
...
## [​](#6-keep-it-running-service) 6) Keep it running (service)
