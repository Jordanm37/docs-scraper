---
title: Macos vm - Clawdbot
url: https://docs.clawd.bot/platforms/macos-vm
---

# [​](#clawdbot-on-macos-vms-sandboxing) Clawdbot on macOS VMs (Sandboxing)
...
## [​](#6-install-clawdbot) 6) Install Clawdbot
...
```
ssh [email protected] "clawdbot status"
```
