---
title: Plugin - Clawdbot
url: https://docs.clawd.bot/plugins
---
...
## [​](#control-ui-schema-+-labels) Control UI (schema + labels)
...
### [​](#write-a-new-messaging-channel-step‑by‑step) Write a new messaging channel (step‑by‑step)
