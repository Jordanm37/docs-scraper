---
title: Anthropic - Clawdbot
url: https://docs.clawd.bot/providers/anthropic
---
...
## [​](#option-b:-claude-code-cli-setup-token-or-oauth) Option B: Claude Code CLI (setup-token or OAuth)
