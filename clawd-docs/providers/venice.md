---
title: Venice - Clawdbot
url: https://docs.clawd.bot/providers/venice
---

# [​](#venice-ai-venius-highlight) Venice AI (Venius highlight)
...
## [​](#why-venice-in-clawdbot) Why Venice in Clawdbot
...
### [​](#2-configure-clawdbot) 2. Configure Clawdbot
...
## [​](#available-models-25-total) Available Models (25 Total)

### [​](#private-models-15-—-fully-private,-no-logging) Private Models (15) — Fully Private, No Logging
...
### [​](#anonymized-models-10-—-via-venice-proxy) Anonymized Models (10) — Via Venice Proxy
...
## [​](#streaming-&-tool-support) Streaming & Tool Support
...
## [​](#comparison:-venice-vs-direct-api) Comparison: Venice vs Direct API
...
### [​](#api-key-not-recognized) API key not recognized
