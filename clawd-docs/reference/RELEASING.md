---
title: RELEASING - Clawdbot
url: https://docs.clawd.bot/reference/RELEASING
---

# [​](#release-checklist-npm-+-macos) Release Checklist (npm + macOS)
...
* Verify the registry: `npm view clawdbot version`, `npm view clawdbot dist-tags`, and `npx -y [email protected] --version` (or `--help`).
...
* From a clean temp directory (no `package.json`), run `npx -y [email protected] send --help` to confirm install/CLI entrypoints work.
