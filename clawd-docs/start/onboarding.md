---
title: Onboarding - Clawdbot
url: https://docs.clawd.bot/start/onboarding
---
...
## [​](#page-order-current) Page order (current)
...
## [​](#2-local-only-auth-anthropic-oauth) 2) Local-only auth (Anthropic OAuth)
...
## [​](#3-setup-wizard-gateway‑driven) 3) Setup Wizard (Gateway‑driven)
...
## [​](#agent-bootstrap-ritual) Agent bootstrap ritual
...
## [​](#optional:-gmail-hooks-manual) Optional: Gmail hooks (manual)
...
## [​](#remote-mode-notes) Remote mode notes
