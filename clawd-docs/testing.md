---
title: Testing - Clawdbot
url: https://docs.clawd.bot/testing
---
...
### [​](#unit-/-integration-default) Unit / integration (default)
...
### [​](#live-real-providers-+-real-models) Live (real providers + real models)
...
### [​](#layer-2:-gateway-+-dev-agent-smoke-what-“@clawdbot”-actually-does) Layer 2: Gateway + dev agent smoke (what “@clawdbot” actually does)
...
### [​](#modern-smoke-set-tool-calling-+-image) Modern smoke set (tool calling + image)
...
### [​](#vision:-image-send-attachment-→-multimodal-message) Vision: image send (attachment → multimodal message)
...
### [​](#aggregators-/-alternate-gateways) Aggregators / alternate gateways
...
## [​](#docker-runners-optional-“works-in-linux”-checks) Docker runners (optional “works in Linux” checks)
