...
url: https://docs.clawd.bot/tools
---

# [​](#tools-clawdbot) Tools (Clawdbot)
...
### [​](#sessions_list-/-sessions_history-/-sessions_send-/-sessions_spawn-/-session_status) `sessions_list` / `sessions_history` / `sessions_send` / `sessions_spawn` / `session_status`
