...
url: https://docs.clawd.bot/tools/browser
---

# [​](#browser-clawd-managed) Browser (clawd-managed)
...
## [​](#profiles:-clawd-vs-chrome) Profiles: `clawd` vs `chrome`
...
## [​](#remote-browser-control-server) Remote browser (control server)
...
### [​](#tokens-what-is-shared-with-what) Tokens (what is shared with what?)
...
### [​](#binding-don’t-expose-to-your-lan-by-accident) Binding (don’t expose to your LAN by accident)
...
### [​](#tls-/-https-recommended-approach:-terminate-in-front) TLS / HTTPS (recommended approach: terminate in front)
...
## [​](#agent-tools-+-how-control-works) Agent tools + how control works
