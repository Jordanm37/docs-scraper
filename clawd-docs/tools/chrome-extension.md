---
title: Chrome extension - Clawdbot
...
## [​](#do-i-need-clawdbot-browser-serve) Do I need `clawdbot browser serve`?

### [​](#local-gateway-same-machine-as-chrome-—-usually-no) Local Gateway (same machine as Chrome) — usually **no**
...
### [​](#remote-gateway-gateway-runs-elsewhere-—-yes) Remote Gateway (Gateway runs elsewhere) — **yes**
...
## [​](#remote-gateway-recommended:-tailscale-serve) Remote Gateway (recommended: Tailscale Serve)
