---
title:  Mathpix Markdown User Guide: Theorems and proofs
url: https://mathpix.com/docs/mathpix-markdown/theorems-and-proofs
---
...
* [Theorems and proofs](#theorems-and-proofs)
  ...
  + [Numbered theorems, definitions, corollaries and lemmas](#numbered-theorems%2C-definitions%2C-corollaries-and-lemmas)
  + [Unnumbered theorem-like environments](#unnumbered-theorem-like-environments)
  + [Theorem styles](#theorem-styles)
  + [Proofs](#proofs)
  + [Changing the QED symbol](#changing-the-qed-symbol)
  + [Start theorem counter from specific number](#start-theorem-counter-from-specific-number)
...
![Output](/images/theorem-output.webp)
...
![Output](/images/theorem-output1.webp)

There are three new environments defined in the preamble.

`\newtheorem{theorem}{Theorem}[section]` This is the example presented in the introduction, but it has the additional parameter `[section]` that restarts the theorem counter at every new section.
...
![Output](/images/theorem-output2.webp)
...
![Output](/images/theorem-output3.webp)
...
![Output](/images/theorem-output4.webp)
...
![Output](/images/theorem-output5.webp)

## Start theorem counter from specific number

`\setcounter{theoremenv}{number}` Sets count for `theoremenv` to contain the value number.
...
![Output](/images/theorem-output6.webp)
