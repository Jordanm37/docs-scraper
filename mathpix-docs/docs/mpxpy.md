---
title:  Mathpix Python SDK Overview
url: https://mathpix.com/docs/mpxpy
---

* [Docs](/docs)  >
* [Python SDK](/docs/mpxpy/overview)  >
* [What is Mathpix Python SDK?](overview)

# What is Mathpix Python SDK?

[Mathpix Python SDK (mpxpy)](https://pypi.org/project/mpxpy/) is the official Python client for accessing Mathpix API services. It offers a simple and flexible way to integrate OCR, document conversion, and Mathpix Markdown (MMD) processing into your Python applications.
...
![Mathpix Python SDK Details](/images/SDK-processing-image.webp)
...
The SDK is open source and available on [GitHub](https://github.com/Mathpix/mpxpy). It is compatible with major Python environments and is distributed via [PyPI](https://pypi.org/project/mpxpy/) for easy installation.
