---
title: PDF to Overleaf
url: https://mathpix.com/pdf-to-overleaf
---

# Convert PDF to Overleaf

Mathpix Snip converts scientific PDFs to editable Markdown files, which can be exported to Overleaf.
...
## How to convert PDF to Overleaf
...
4. Click "Export" -> "Overleaf" in the top right corner of the page.
...
## Read more PDF Conversion related posts on our blog
